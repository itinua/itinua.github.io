...
Мы рассматриваем интересные статьи которые относятся к тематике нашего сайта от всех пользователей.Такие статьи мы разместим после модерации.
...
**img: money-minimal.jpg** Обязательное имя картинки, картинку администрация добавит  в папку ***images*** 

**author: ivan-ivanenko** Если есть автор  

**---**

И тело статьи (статью нужно отформатировать с помощью облегченного языка разметки Маркдаун (вверху даного материала есть ссылка, кликнув на которую можно ознакомиться с правилами использования Маркдаун).
...
1) Отправить нам фото по почте ( если Вы хотите, что бы Ваша фотография была на сайте). 
...
например  
         ...
         firstname-lastname:
           ...
           web: 
           git: 
3) Назвать страницу автора по принципу *firstname-lastname.md* Создать страницу автора в **/content/author** по шаблону, который представлен ниже (его можно просто скопировать вместе с нижними и верхними тире) и вставить на страницу нового автора.
<pre>
---
layout: userprofile
