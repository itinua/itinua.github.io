...
Это и есть хорошее имя для файла, которое нужно скопировать с формы создания имени файла и вставить в поле ( как на скриншоте) при создании статьи. Для того, что бы создать статью нужно перейти на Github, зайти в posts, потом в нужный раздел и возле названия раздела нажать на "+".

Далее вставляем имя файла в поле "name your file" ( которое мы скопировали ранее).
