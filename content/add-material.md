...
Название <input type="text" id="btnSearch" size="60" onkeypress="onKey(event);"/>
<button onclick="onKey({keyCode:13});">Транслит</button><br/><br/>
Автор

<select onchange="onAuthor(this.value);">
