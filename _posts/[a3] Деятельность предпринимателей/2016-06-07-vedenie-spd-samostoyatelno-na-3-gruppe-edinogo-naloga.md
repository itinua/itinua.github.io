...
author: anna-ivanenko katerina-britskaya
--- 
...
где 1378 грн-минимальная заработная 
...
С этой целью подходите в налоговую инспекцию, где есть центр сертификации ключей (местонахождения центров сертификации можно проверить [здесь](http://acskidd.gov.ua/contacts) с таким документами:
